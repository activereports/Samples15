	...
	public class RtfControlLayoutManager : ILayoutManager
	{
		...
		private string GetNextRtf(float to)
		{
			...
			using (var rtb = new RichTextBoxFixed())
			{
				...
				_lastChar = rtb.TextLength - 1 == _lastChar ? rtb.TextLength : _lastChar;
		...
		private readonly float TWIPS_PER_PIXEL = GlobalConstants.FTwipsPerInch / RenderUtils.VerticalResolution;
