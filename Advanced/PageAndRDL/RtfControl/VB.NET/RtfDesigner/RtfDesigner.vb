		...
		Public Overrides Sub Paint(pe As PaintEventArgs)
			...
			Try
				...
				If meta IsNot Nothing Then
					...
					pe.Graphics.DrawImage(meta, New RectangleF(Bounds.X, Bounds.Y, _reportItem.Width.ToInches() * RenderUtils.HorizontalResolution * designer.ConversionService.ScalingFactor, _reportItem.Height.ToInches() * RenderUtils.VerticalResolution * designer.ConversionService.ScalingFactor))
				End If
