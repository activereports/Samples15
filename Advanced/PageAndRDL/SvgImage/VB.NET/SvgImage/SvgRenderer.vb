...
Public NotInheritable Class SvgRenderer
	...
	Function GetGraphics() As Graphics Implements IGraphicsProvider.GetGraphics
		If _measurer Is Nothing Then _measurer = CreateReferenceGraphics()
		Return _measurer
	End Function
...
#Region "Helpers"
	...
	Private Shared ReadOnly _refBitmap As Bitmap = New Bitmap(1, 1)

	Private Shared Function CreateReferenceGraphics() As Graphics
	...
	Private Shared Function CreateMetafile(ms As MemoryStream, size As SizeF) As Image
		Using gTemp As Graphics = CreateReferenceGraphics()
